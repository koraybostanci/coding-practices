...
public class P03_StackOfPlates {
    ...
    public void testPushPop() {
        ...
        Assertions.assertEquals("c", item);
        ...
        Assertions.assertEquals("g", item);
    }
    ...
    public void testPopAt() {
        ...
        Assertions.assertEquals("b", item);

        item = setOfStacks.popAt(1);
        Assertions.assertEquals("c", item);

        item = setOfStacks.popAt(0);
        Assertions.assertEquals("a", item);
    }
    ...
    public void testPopAtException() {
        ...
        Assertions.assertThrows(ArrayIndexOutOfBoundsException.class, () -> setOfStacks.popAt(2));
    }
    ...
    public void testPopItemAndRemoveStack() {
        ...
        String item = setOfStacks.pop();
        Assertions.assertEquals(setOfStacks.stacks.size(),1);
    }
}
