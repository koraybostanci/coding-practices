...
public class P05_OneWay {
    ...
    @Test
    public void test1() {
        Assertions.assertTrue(areMaxOneEdit("pale", "ple"));
    }

    @Test
    public void test2() {
        Assertions.assertTrue(areMaxOneEdit("pales", "pale"));
    }

    @Test
    public void test3() {
        Assertions.assertTrue(areMaxOneEdit("pale", "bale"));
    }

    @Test
    public void test4() {
        Assertions.assertFalse(areMaxOneEdit("pale", "bae"));
    }

    @Test
    public void test5() {
        Assertions.assertFalse(areMaxOneEdit("pale", "file"));
    }
